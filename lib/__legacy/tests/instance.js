// import { emptyDir, exists, read, write } from 'firost';
// import Current from '../instance.js';
...
//       expect(await exists(output)).toEqual(false);
//     });
//   });
...
//   });
//   describe('toImage', () => {
//     fit('should create an image of the PDF', async () => {
...
//       expect(await exists(output)).toEqual(true);
//     });
...
//       const pdf = new Current(`${fixturesDirectory}/foo.pdf`);
//       const output = `${tmpDirectory}/foo.png`;
//       vi.spyOn(pdf, 'run').mockImplementation(() => {
//         throw new Error('you are not allowed');
//       });
//       vi.spyOn(dependencyChecker, 'error').mockReturnValue({
//         message: 'instructions',
//       });
//       vi.spyOn(pdf, '__exit').mockReturnValue();
...
//       expect(await exists(`${output}/000.png`)).toEqual(true);
//       expect(await exists(`${output}/001.png`)).toEqual(true);
//     });
//   });
//   describe('imageList', () => {
...
//       const pdf = new Current(`${fixturesDirectory}/foo.pdf`);
//       vi.spyOn(pdf, 'run').mockReturnValue({ stdout: mockList });
